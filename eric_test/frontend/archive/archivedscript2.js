...
function createAndAddMarker(data) {
    L.marker([data.latitude, data.longitude])
        .addTo(map)
        .bindPopup(`<b>${data.name}</b><br>Cuisine: ${data.cuisine}<br><a href="${data.url}" target="_blank">View on Kayak</a>`);
}

// Load restaurant data and apply filters
